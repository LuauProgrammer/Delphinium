...
function destruction:banMembersAndSendMessage(clientMember, authorId, members, message)
    ...
    members:forEach(function(member)
        xpcall(function()
            if member.user.id ~= clientMember.user.id and member.user.id ~= authorId then
                pcall(function()
